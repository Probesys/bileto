...
class MessageTemplateForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('content', Type\TextareaType::class, [
            ...
            'label' => new TranslatableMessage('message_templates.content'),
            'block_prefix' => 'editor',
        ]);

        $builder->add('type', Type\ChoiceType::class, [
            'choices' => [
                'message_templates.type.normal' => 'normal',
                'message_templates.type.confidential' => 'confidential',
                'message_templates.type.solution' => 'solution',
            ],
