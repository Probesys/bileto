...
class Task implements EntityInterface, MonitorableEntityInterface, UidEntityInterface
{
    ...
    public function setMessage(?Message $message): static
    {
        ...
        $this->setTicket($message->getTicket());
    ...
    {
        return $this->setFinishedAt(Utils\Time::now());
    }
    ...
    {
        return !$this->isFinished() && $this->startAt <= Utils\Time::now();
    }

    public function isPlanned(): bool
    {
        return !$this->isFinished() && !$this->isOngoing();
    }
